...
class UserLogin extends Component {
  constructor(props) {
    ...
    this.state = { name:'',pwd:'',validationState:validationState,helpBlock:helpBlock,rows:[],defaultLanguage:locals[0].name,selectedLanguage:locals[0],languageimg:{uri:MainConstant.url+MainConstant.app+'/'+this.minnUtil.get('main_language_flagImg'),isStatic:false}};
  }
  ...
  onSelect(data) {
    ...
    console.log('image:'+this.minnUtil.get('main_language_flagImg'));
